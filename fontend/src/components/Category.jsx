...
<h2 className='text-2xl my-10 font-semibold '>Sci-fi</h2>
            ...
            >
                <Card className='w-40 border-none'>
                  <CardContent className=" aspect-square items-center justify-center p-6">
                    <img src={book} alt='book' className='w-full rounded-md'/>
                                    <p className='mt-2 capitalize text-center'>{head.name}</p>
</CardContent>
                </Card>
            </CarouselItem>
          ))}
